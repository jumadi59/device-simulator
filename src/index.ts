 ...
 * npx ts-node index.ts --serial SN-TEST-0001 --url mqtt://localhost:1883
 */
...
const argv = yargs(hideBin(process.argv))
    ...
    .option("serial", { type: "string", default: process.env.SERIAL})
...
async function execute(job: string, payload: unknown): Promise<{ ok: boolean; out?: unknown; err?: string }> {
    switch (job) {
        ...
        case "get_terminal_info": {
            return {
                ok: true,
                out: {"battery_percentage":45.0,"connection":{"connection_level":4,"connection_name":"WIFI","latency":24,"private_ip":"192.168.100.25"},"installed_apps":[{"icon":"uploads/icon-com.cz.app.deeplink_1.png","label":"Deeplink-app","package_name":"com.cz.app.deeplink","version_code":1,"version_name":"1.0"},{"icon":"uploads/icon-com.cz.app.v2.dev_3015.png","label":"Cashlez dev","package_name":"com.cz.app.v2.dev","version_code":3015,"version_name":"2.19.73dev"},{"icon":"uploads/icon-com.example.simulator_1.png","label":"Simulator","package_name":"com.example.simulator","version_code":1,"version_name":"1.0"},{"icon":"uploads/icon-com.jumadi.app.rg_1.png","label":"receipt-generator","package_name":"com.jumadi.app.rg","version_code":1,"version_name":"1.0"},{"icon":"uploads/icon-com.koushikdutta.vysor_1708394400.png","label":"Vysor","package_name":"com.koushikdutta.vysor","version_code":1708394400,"version_name":"4.2.2"},{"icon":"uploads/icon-videoeditor.videorecorder.screenrecorder_2362000.png","label":"XRecorder","package_name":"videoeditor.videorecorder.screenrecorder","version_code":2362000,"version_name":"2.3.6.2"},{"icon":"uploads/icon-id.bluebird.com.outlet.pos_1.png","label":"mobile-pos","package_name":"id.bluebird.com.outlet.pos","version_code":1,"version_name":"1.0"}],"latitude":-6.21462,"longitude":106.84513,"ram":{"native_heap_free_size":1386094592,"native_heap_size":2013794304,"used_mem_in_bytes":627699712,"used_mem_in_percentage":31},"storage":{"storage_free":11410329600,"storage_percentage":28,"storage_total":16000000000,"storage_used":4589670400},"serial_number":"P551700121971","uptime_device":60827,"battery_status":"Not Charging","firmware":"Z516AA_CASHLEZ_T1_TSEC_V2.0.4_user"},
            };
        }
        case "reboot": {
            return { ok: true };
