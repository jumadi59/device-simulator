...
async function execute(job: string, payload: unknown): Promise<{ ok: boolean; out?: unknown; err?: string }> {
    switch (job) {
        ...
        case "get_terminal_info": {
            return {
                ok: true,
                out: {"battery_percentage":45.0,"connection":{"connection_level":4,"connection_name":"WIFI","latency":24,"private_ip":"192.168.100.25"},"installed_apps":[{"icon":"uploads/icon-id.bluebird.com.outlet.pos_1.png","label":"mobile-pos","package_name":"id.bluebird.com.outlet.pos","version_code":1,"version_name":"1.0"}],"latitude":-6.21462,"longitude":106.84513,"ram":{"native_heap_free_size":1386094592,"native_heap_size":2013794304,"used_mem_in_bytes":627699712,"used_mem_in_percentage":31},"storage":{"storage_free":11410329600,"storage_percentage":28,"storage_total":16000000000,"storage_used":4589670400},"serial_number":"SN-TEST-000235","uptime_device":60827,"battery_status":"Not Charging","firmware":"Z516AA_CASHLEZ_T1_TSEC_V2.0.4_user"},
            };
        }
        case "reboot": {
            return { ok: true };
